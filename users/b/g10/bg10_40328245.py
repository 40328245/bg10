...
@bg10_40328245.route('/circle')
def drawcircle():
    return head_str + chain_str + circle(0, 0) + tail_str
 
 
@bg10_40328245.route('/circle1/<degree>', defaults={'x': 0, 'y': 0})
@bg10_40328245.route('/circle1/<x>/<degree>', defaults={'y': 0})
@bg10_40328245.route('/circle1/<x>/<y>/<degree>')
...
@bg10_40328245.route('/circle2/<degree>', defaults={'x': 0, 'y': 0})
@bg10_40328245.route('/circle2/<x>/<degree>', defaults={'y': 0})
@bg10_40328245.route('/circle2/<x>/<y>/<degree>')
...
@bg10_40328245.route('/twocircle/<x>/<y>')
@bg10_40328245.route('/twocircle', defaults={'x':0, 'y':0})
def drawtwocircle(x,y):
    return head_str + chain_str + twocircle(int(x), int(y)) + tail_str
 
 
@bg10_40328245.route('/eighteenthirty/<x>/<y>')
@bg10_40328245.route('/eighteenthirty', defaults={'x':0, 'y':0})
def draweithteenthirdy(x,y):
    return head_str + chain_str + eighteenthirty(int(x), int(y)) + tail_str
 
 
@bg10_40328245.route('/snap')
...
'''
    return outstring
@bg10_40328245.route('/threegears', defaults={'n1':17,'n2':29,'n3':15,'n4':21,'n5':23})
@bg10_40328245.route('/threegears/<n1>/<n2>/<n3>/<n4>/<n5>')
def draw_threegears(n1, n2, n3,n4,n5):
    outstring='''
<!DOCTYPE html>
<html>
<head>
...
spur(cx+pr1+pr2+pr2+pr3+pr3+pr4, cy, m, n4, pa, 180-180/n3*n3/n4+(180-180/n3)*n3/n4+(180-180/n2)*n2/n3*n3/n4)
spur(cx+pr1+pr2+pr2+pr3+pr3+pr4+pr4+pr5, cy, m, n5, pa , 180-180/n4*n4/n5+(180-180/n4)*n4/n5+(180-180/n4)*n4/n5+(180-180/n2)*n2/n3*n3/n4*n4/n5)
</script>'''
    return outstring
